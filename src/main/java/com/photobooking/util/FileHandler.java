...
/**
 * File Handling Utility for the Event Photography System's booking functionality.
 * Provides methods for file operations required to persist and retrieve booking data.
 */
