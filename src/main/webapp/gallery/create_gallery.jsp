...
<head>
  ...
  <title>Create Gallery - SnapHouse</title>
...
<div class="container">
  ...
  <div class="form-container">
    <div class="form-header">
      <h1 class="h3">Create New Gallery</h1>
      <p class="text-muted">Create a new photo gallery to showcase your work</p>
    </div>

    <form action="${pageContext.request.contextPath}/gallery/create" method="post">
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <select class="form-select" id="bookingId" name="bookingId">
          ...
          <c:forEach var="booking" items="${bookings}">
            <option value="${booking.bookingId}">${booking.eventType} - <fmt:formatDate value="${booking.eventDateTime}" pattern="MMM dd, yyyy"/></option>
          </c:forEach>
        </select>
      </div>
      ...
      <div class="mb-3">
        ...
        <select class="form-select" id="status" name="status">
          ...
          <option value="PRIVATE">Private (Only visible to client)</option>
      ...
      <div class="form-footer d-flex justify-content-between">
        ...
        <button type="submit" class="btn btn-primary">
          <i class="bi bi-plus-circle"></i> Create Gallery
        </button>
      </div>
    </form>
  </div>
